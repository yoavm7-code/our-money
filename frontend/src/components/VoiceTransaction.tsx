    ...
    <>
      ...
      {hidden ? (
        ...
        <button
          ...
          className="fixed bottom-20 md:bottom-24 end-0 z-40 px-1 md:px-1.5 py-2 md:py-3 rounded-s-lg bg-gradient-to-b from-primary-500 to-primary-600 text-white shadow-md hover:shadow-lg hover:px-1.5 md:hover:px-2 transition-all duration-200 flex flex-col items-center gap-1 opacity-70 hover:opacity-100"
          title={t('voice.show')}
        >
        ...
        <div className="fixed bottom-4 end-4 md:bottom-6 md:end-6 z-40 flex items-center gap-1 group">
          <button
            type="button"
            onClick={handleOpen}
            className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 text-white shadow-lg shadow-primary-500/30 hover:shadow-xl hover:shadow-primary-500/40 hover:scale-105 active:scale-95 transition-all duration-200 flex items-center justify-center"
            title={t('voice.title')}
          >
          ...
          {/* Hide button - appears on hover / always visible on mobile */}
          <button
            type="button"
            onClick={handleHide}
